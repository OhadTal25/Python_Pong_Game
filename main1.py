# Thanks to: Sri Manikanta Palakollu.
...
win.title("Ping-Pong Game")  # Name of the game
win.bgcolor('black')  # background color - black
win.setup(width=800, height=600)  # Size of the game panel
win.tracer(0)  # speed up's the game.
...
paddle_left.shapesize(stretch_wid=9, stretch_len=1)
paddle_left.penup() # Moving the paddle without drawing
paddle_left.goto(-350, 0) # Move to (-350, 0)
...
paddle_right.shapesize(stretch_wid=9, stretch_len=1)
